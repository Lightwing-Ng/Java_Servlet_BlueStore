                    ...
                    <c:forEach items="${cart.cartItems}" var="item">
                        <tr class="active">
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" title="${item.product.pid}"
                                   class="delete" id="${item.product.pid}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
            ...
            <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                ...
                <a href="${pageContext.request.contextPath}/OrderServlet?method=saveOrder">
                    ...
                    <input type="button" width="100" value="提交订单" name="submit" border="0"
                           style="background:
                                   url('${pageContext.request.contextPath}/img/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
