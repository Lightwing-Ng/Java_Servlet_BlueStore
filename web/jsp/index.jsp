...
<div class="container-fluid">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="${ pageContext.request.contextPath }/img/ad/1.png">
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <h2>Latest&nbsp;&nbsp;&nbsp;<span class="BlueCloud">Powered By BlueCloud®️</span></h2>
        </div>
            ...
            <c:forEach items="${news}" var="p">
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    <a
                        ...
                        <img src="${pageContext.request.contextPath}/${p.pimage}" width="130"
        ...
        <div class="col-md-10">
            ...
            <c:forEach items="${hots}" var="p">
                <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                    ...
                    <p>
                        <span style="font-size: 16px; color: #0F88EB">
                            &yen;${ p.shop_price }
                        </span>
                    </p>
                </div>
    ...
    <div class="container-fluid">
        ...
        <div style="margin-top:50px;">
            <img src="${pageContext.request.contextPath}/img/footer.jpg" width="100%" height="78"
                 alt="我们的优势" title="我们的优势"/>
        </div>

        <div style="text-align: center;margin-top: 5px;">
            <ul class="list-inline">
                <li><a href="${ pageContext.request.contextPath }/jsp/info.jsp">About Us</a></li>
        ...
        <div style="text-align: center; margin-top: 5px; margin-bottom:20px;">
            Copyright &copy; 2012-2018 Lightwing Ng, All Rights Reserved
        </div>
    </div>
</div>
</body>
